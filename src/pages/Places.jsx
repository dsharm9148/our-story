...
const visited = [
  ...
  },
  {
    ...
    country: 'USA',
    season: 'Winter 2025',
    memory: 'Our first US trip together — winter wonderland ❄️',
  },
  {
    id: 7,
    name: 'Boston',
  ...
  return (
    <div style={styles.page}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>Places we've explored together &amp; destinations we dream about</p>
      </div>
      ...
      <div style={styles.stats}>
        ...
        <div style={{ ...styles.stat, background: '#e0f2fe', border: '1px solid #bae6fd' }}>
          ...
          <span style={styles.statLabel}>Dream Destinations</span>
        </div>
...
const styles = {
  ...
  mapIcon: { fontSize: 40, marginBottom: 12 },
  title: {
    fontSize: 36,
    fontWeight: '800',
    color: '#1a2e1a',
